...
<header
	class="pointer-events-none fixed top-0 left-0 right-0 z-30 flex justify-center gap-3 bg-gradient-to-t from-primary-100/0 to-primary-100 p-4 lg:px-6"
>
	<h1
	...
	{#if $page.data.session}
		...
		<a
			class="pointer-events-auto my-auto flex flex-shrink-0 transform-gpu items-center justify-center gap-2 rounded-[1.75rem] bg-white/90 py-1 px-1 text-primary-600 transition-all hover:bg-white/95 hover:shadow hover:shadow-primary-600/10 focus:bg-white/95 active:bg-white/75 active:shadow-none sm:pr-4 sm:backdrop-blur-sm lg:backdrop-blur"
			href="/account"
		...
		>
			...
			<div class="pointer-events-auto my-auto hidden sm:grid">
				...
				<div
					class="max-w-[8rem] text-sm font-bold text-primary-900 line-clamp-1"
